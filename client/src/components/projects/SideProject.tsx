...
export const SideProject: React.FC<Props> = ({ project }) => {
   return (
      <article className="group grid relative gap-8 justify-items-end odd:justify-items-start">
         ...
         <div className="grid grid-cols-[1fr_max-content] bg-white md:gap-8 md:w-[70%] md:my-6 md:min-h-[260px] md:z-10 md:p-9 md:pb-5 md:shadow-lg ">
            <div className="grid grid-rows-[max-content_1fr_max-content_max-content] gap-2">
