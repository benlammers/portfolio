...
export const HighlightedProject: React.FC<Props> = ({ project }) => {
   return (
      <article className="group grid relative gap-4 sm:gap-8 justify-items-end odd:justify-items-start">
         ...
         <div className="grid grid-rows-[max-content_1fr_max-content] gap-4 md:shadow-lg md:w-[70%] lg:w-2/3 md:my-10 bg-white md:min-h-[420px] md:z-10 md:p-9">
            <div className="flex flex-col">
               <h3 className="heading-label text-amber-400 font-bold">{project.name}</h3>
            ...
            <div className="flex flex-col gap-6 items-start justify-between sm:items-center sm:gap-4 sm:flex-row-reverse mt-2">
               ...
               <button className="grid grid-cols-[1fr_max-content] pr-2 min-w-[10rem] md:min-w-[9rem] lg:min-w-[10rem] shadow-md items-center bg-amber-400 transition-colors">
                  <span className="w-full text-lg text-center py-1">View Project</span>
                  <svg className="stroke-black h-4 w-4 pt-[1px]" viewBox="0 0 16 16" fill="none">
